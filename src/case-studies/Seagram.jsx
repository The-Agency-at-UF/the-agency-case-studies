...
import { AnimateOnScroll } from "../components/AnimateOnScroll"; // adjust path if needed
  ...
  return (
    <div className="relative bg-black text-white font-monserrat overflow-x-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: "url('src/assets/images/seagrams/seagrambg.png')" }}
      ></div>
      ...
      <div className="relative">
        <img
          src="src/assets/images/seagrams/bubbles.png"
          alt="Seagram Mockup"
      ...
      <AnimateOnScroll className="relative z-10 px-40 pt-[345px] flex flex-col items-start space-y-12">
        ...
        <div className="flex items-center space-x-4">
          <img src="src/assets/images/seagrams/seagramlogo.png" alt="Seagram" className="w-[425px] h-auto" />
          <p className="text-lg font-extrabold">X</p>
          <img src="src/assets/images/The Agency_White Logo.png" alt="The Agency" className="w-[425px] h-auto" />
        </div>
      ...
      {/* Opportunity Section */}
      <AnimateOnScroll id="The Opportunity" className="relative z-10 px-40 pt-[150px] flex flex-col items-start space-y-12">
        ...
        <div className="flex text-[1.7rem] leading-relaxed w-[1300px]">
          ...
          <img
            src="src/assets/images/seagrams/seagramgold.png"
            alt="Seagram Mockup"
      ...
      <section id="scrolling-packages" className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen mt-20">
        <img
          src="src/assets/images/seagrams/packageScroll.png"
          alt="Seagram"
      ...
      {/* Solution Section */}
      <AnimateOnScroll id="The solution" className="relative z-10 px-40 pt-[5px] flex flex-col items-start space-y-10">
        <div className="mt-20 w-[1300px]">
          <div className="w-[700px] font-extrabold text-[6rem] leading-snug">
            <p>THE</p>
          </div>
      ...
      {/* Impact Section */}
      <AnimateOnScroll id="The Impact" className="relative z-10 px-40 pt-[40px] flex flex-col items-start space-y-12">
        <div className="mt-40 w-[1300px] relative flex items-start justify-between">
          ...
          <img
            src="src/assets/images/seagrams/Mockup.png"
            alt="Seagram Mockup"
      ...
      {/* Logo Footer */}
      <div className="flex items-center space-x-4 relative z-10 justify-center mt-[200px]">
        <img src="src/assets/images/seagrams/seagramlogo.png" alt="Seagram" className="w-[425px] h-auto" />
        <p className="text-lg font-extrabold">X</p>
        <img src="src/assets/images/seagrams/The Agency_White Logo.png" alt="The Agency" className="w-[425px] h-auto" />
      </div>

      {/* Scroll Space */}
      <div className="relative -mt-[25rem] text-white text-3xl font-bold z-10">
        <img
          src="src/assets/images/seagrams/delicious-healthy-tea-concept-with-copy-space 1.png"
          alt="Seagram"
